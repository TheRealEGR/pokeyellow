...
TyrogueEvosMoves:
; Evolutions
	db EVOLVE_ITEM, THUNDER_STONE, 1, HITMONLEE
	db EVOLVE_ITEM, WATER_STONE, 1, HITMONCHAN
	db EVOLVE_ITEM, FIRE_STONE, 1, HITMONTOP
	db 0
; Learnset
	db 1, TACKLE
	db 1, FOCUS_ENERGY
...
; Evolutions
	...
	db EVOLVE_ITEM, MOON_STONE, 1, GLACEON
	db 0
; Learnset
	db 8, SAND_ATTACK
	db 16, GROWL
